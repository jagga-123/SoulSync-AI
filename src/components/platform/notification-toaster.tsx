...
export function NotificationToaster() {
  ...
  return (
    <div
      aria-live="polite"
      className="toaster-region pointer-events-none fixed inset-x-0 bottom-4 z-[80] flex flex-col items-center gap-2 px-4 sm:inset-x-auto sm:right-4 sm:items-end"
    >
      <AnimatePresence>
